...
public class JsonSchema implements ParsedSchema {
  ...
  public void validate(JsonNode value) throws JsonProcessingException, ValidationException {
    if (skemaObj != null) {
      validate(skemaObj, value);
    } else {
      validate(rawSchema(), value);
    }
  }

  public static void validate(com.github.erosb.jsonsKema.Schema schema, JsonNode value)
